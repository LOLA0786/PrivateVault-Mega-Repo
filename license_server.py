...
VALID_LICENSES = {
    "LICENSE_STRIPE_001": {"client": "Stripe", "expires": "2030-01-01", "status": "ACTIVE"},
    "LICENSE_HEDGE_FUND_X": {"client": "HedgeFundX", "expires": "2026-12-31", "status": "ACTIVE"},
    "LICENSE_TEST_TRIAL": {"client": "TrialUser", "expires": "2026-02-01", "status": "ACTIVE"},
}
